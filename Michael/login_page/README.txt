...
Login page: enter the valid UWO email and password to enter the welcome page. If u want to register, press the register button of the login page to enter the register page. Press the back button of the register page to back the login page.
